...
export default async function AdminDashboardPage() {
  ...
  const stats = [
    ...
    { label: "Blog Posts", value: blogPosts.length, icon: FileText, color: "text-ink" },
    ...
    <div>
      ...
      <div className="bg-canvas border border-hairline shadow-sm rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          <Link href="/admin/blog" className="p-4 rounded-lg bg-surface-soft border border-transparent hover:border-hairline text-ink/70 hover:text-ink text-sm transition-colors text-center font-medium">+ Write Blog Post</Link>
