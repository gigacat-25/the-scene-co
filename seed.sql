...
INSERT INTO portfolio_items (title, slug, category, description, image_url, client_name, technologies, is_featured) VALUES
  ...
  ('Retail POS Dashboard', 'retail-pos-dashboard', 'POS', 'Custom POS dashboard for a retail chain with 15 stores. Real-time sales tracking, inventory sync, and staff management.', 'https://images.unsplash.com/photo-1556740758-90de940de450?auto=format&fit=crop&w=800&q=80', 'StyleMart Retail', '["Next.js", "D1", "Recharts"]', 0),
