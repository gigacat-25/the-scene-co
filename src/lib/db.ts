...
const fallbackPortfolio = [
  { 
    id: 1, 
    title: 'Rotaract District 3192 Website', 
    slug: 'rotaract-district-3192-website', 
    category: 'Website', 
    description: 'An interactive, custom-designed community platform for Rotaract District 3192. Serves as a portal for member clubs, events, and announcements.', 
    image_url: 'https://images.unsplash.com/photo-1541872703-74c5e44368f9?auto=format&fit=crop&w=800&q=80', 
    client_name: 'Rotaract District 3192', 
    technologies: '["Next.js", "D1 Database", "Cloudflare Pages", "Clerk Auth"]', 
    is_featured: 1, 
    is_published: 1 
  },
  { 
    id: 2, 
    title: 'Nandini Milk Delivery & Ordering System', 
    slug: 'nandini-milk-delivery-ordering-system', 
    category: 'E-commerce', 
    description: 'A comprehensive digital supply chain and order management portal built for Nandini Milk delivery agents. Features instant billing, route planning, and subscription packages.', 
    image_url: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?auto=format&fit=crop&w=800&q=80', 
    client_name: 'Nandini Milk Agents Association', 
    technologies: '["Next.js", "D1", "Tailwind CSS", "Razorpay", "Node.js"]', 
    is_featured: 1, 
    is_published: 1 
  },
  { 
    id: 3, 
    title: 'ImpactOne Platform', 
    slug: 'impactone-platform', 
    category: 'Website', 
    description: 'A crowdfunding and donation management portal designed to connect non-profits with corporate donors. Includes automated tax receipts and donation tracking.', 
    image_url: 'https://images.unsplash.com/photo-1593113598332-cd288d649433?auto=format&fit=crop&w=800&q=80', 
    client_name: 'ImpactOne Foundation', 
    technologies: '["Next.js", "D1", "Stripe", "PDFKit", "Tailwind CSS"]', 
    is_featured: 1, 
    is_published: 1 
  },
  { 
    ...
    slug: 'ugama-aarambha-2k26', 
    category: 'Website', 
    description: 'A high-traffic, interactive event portal designed for the joint installation ceremony. Features attendee registration, guest details, and live schedules.', 
    image_url: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&w=800&q=80', 
    client_name: 'UGAMA Committee', 
    technologies: '["Next.js", "Framer Motion", "D1", "Razorpay"]', 
    is_featured: 0, 
    is_published: 1 
  },
  { 
    id: 5, 
    title: 'Tokyo Tower 3D Website', 
    slug: 'tokyo-tower-3d-website', 
    category: 'Website', 
    description: 'Tokyo Editorial is an immersive, scroll-driven 3D exploration of Tokyo Tower, leveraging WebGL/Three.js for smooth interactive rendering.', 
    image_url: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=800&q=80', 
    client_name: 'Tokyo Editorial', 
    technologies: '["Three.js", "WebGL", "React Three Fiber", "Next.js", "Framer Motion"]', 
    is_featured: 0, 
    is_published: 1 
  },
  { 
    id: 6, 
    title: 'Rotract Club of Swarna Bengaluru', 
    slug: 'rotract-club-swarna-bengaluru', 
    category: 'Website', 
    description: 'We\'re a youth-led club in South Bengaluru. We build solutions for community development, youth empowerment, and professional growth.', 
    image_url: 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=800&q=80', 
    client_name: 'Rotract Club of Swarna Bengaluru', 
    technologies: '["Next.js", "Tailwind CSS", "Cloudflare Pages"]', 
    is_featured: 0, 
    is_published: 1 
  },
  { 
    id: 7, 
    title: 'Ascent Corporate Website', 
    slug: 'ascent-corporate-website', 
    category: 'Website', 
    description: 'A high-performance corporate platform designed for Ascent. Featuring custom 3D elements, fast loading times, and a built-in CMS.', 
    image_url: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80', 
    client_name: 'Ascent Inc.', 
    technologies: '["Next.js", "D1", "R2", "Tailwind CSS"]', 
    is_featured: 0, 
    is_published: 1 
  }
];
...
const fallbackClients = [
  { id: 1, name: 'Rotaract District 3192', logo_url: '', order_index: 1, is_published: 1 },
  { id: 2, name: 'Nandini Milk', logo_url: '', order_index: 2, is_published: 1 },
  { id: 3, name: 'ImpactOne Foundation', logo_url: '', order_index: 3, is_published: 1 },
  { id: 4, name: 'UGAMA Committee', logo_url: '', order_index: 4, is_published: 1 },
  { id: 5, name: 'Tokyo Editorial', logo_url: '', order_index: 5, is_published: 1 },
  { id: 6, name: 'Rotract Club Bengaluru', logo_url: '', order_index: 6, is_published: 1 },
  { id: 7, name: 'Ascent Inc.', logo_url: '', order_index: 7, is_published: 1 }
];
